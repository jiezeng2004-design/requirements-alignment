...
description: Align product direction and high-impact requirements before implementation when the user explicitly invokes $requirements-alignment or asks for requirement alignment. Apply the Greenfield Alignment Gate to blank projects, new products or tools, and vague ideas; do not let reversible or low-risk implementation defaults make product decisions for the user. For existing explicit tasks, ask only about direction-defining or blocking decisions and leave ordinary engineering details to Codex.
---

# Requirements Alignment

<!-- requirements-alignment:version=0.1.0;mode=manual -->
